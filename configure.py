...
target_dir = string(default = '/usr/local')         # where to install?
...
source_url = string                         # URL for source
hash_type = option('md5', 'sha5')           # hashing algorithm
hash = string                               # hash for source
signature = string(default=None)            # GPG signature for source
